                ...
                <ul className="space-y-2">
                    <li className="w-full">
                        <Link to="/admin/manage-students"
                            className={`flex items-center hover:text-gray-300 py-2 px-4 ${location.pathname.includes("/admin/manage-students") ? "bg-white bg-opacity-25" : ""}`}
                        >
                            <BsPeople className="w-5 h-5 mr-2" /> Manajemen Siswa
                        </Link>
                    </li>
                    <li>
                        <Link to="/admin/manage-teachers"
                            className={`flex items-center hover:text-gray-300 py-2 px-4 ${location.pathname.includes("/admin/manage-teachers") ? "bg-white bg-opacity-25" : ""}`}
                        >
                    ...
                    <li>
                        <Link to="/admin/manage-courses"
                            className={`flex items-center hover:text-gray-300 py-2 px-4 ${location.pathname.includes("/admin/manage-courses") ? "bg-white bg-opacity-25" : ""}`}
                        >
