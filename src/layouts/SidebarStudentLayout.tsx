...
const SidebarStudentLayout: React.FC = () => {
        ...
        <div className="bg-[#10141f] backdrop-filter backdrop-blur-lg text-white lg:w-[272px] overflow-hidden">
            <div className="py-4">
                <div className='border-b border-gray-300 mb-4 pb-4'>
                    <h1 className="text-xl font-bold mx-4">Student Panel</h1>
                </div>
                <ul className="space-y-2">
                    <li className="w-full">
                        <Link to="/student/list-courses"
                            className={`flex items-center hover:text-gray-300 py-2 px-4 ${location.pathname.includes("/student/list-courses") ? "bg-white bg-opacity-25" : ""}`}
                        >
...
export default SidebarStudentLayout;
